...
@section('content')
    ...
    <div class="row">
            ...
            <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h1 class="mt-1 mb-3 text-success"><strong> {{ $nbreProduits }}</strong></h1>
                        <div class="mb-0">
                ...
                <!-- Deuxième ligne : Produits disponibles et non disponibles -->
                <div class="row">
                    <!-- Colonne des produits disponibles -->
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Disponibles</h5>
                                <!-- Inclure ici les informations sur les produits disponibles -->
                                <h1 class="mt-3 mb-0 text-info"> 78 932</h1>
                            </div>
                        </div>
                    </div>
    
                    <!-- Colonne des produits non disponibles -->
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Non Disponibles</h5>
                                <!-- Inclure ici les informations sur les produits non disponibles -->
                                <h1 class="mt-3 mb-0 text-warning"> 365</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Deuxième colonne : Graphique et filtres -->
